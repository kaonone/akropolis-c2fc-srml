...
use akropolis_runtime::{self, GenesisConfig, opaque::Block, RuntimeApi};
...
native_executor_instance!(
	pub Executor,
	akropolis_runtime::api::dispatch,
	akropolis_runtime::native_version,
	include_bytes!("../runtime/wasm/target/wasm32-unknown-unknown/release/akropolis_runtime_wasm.compact.wasm")
);
